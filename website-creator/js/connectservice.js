var connectServiceJSON = {
  ...
  "operations":{
	  "AssociateApprovedOrigin":{
	    ...
	    "AssociateInstanceStorage":{
	      "name":"AssociateInstanceStorage",
	      "http":{
	        "method":"POST",
	        "requestUri":"/instance/{InstanceId}/storage"
	      },
	      "input":{"shape":"AssociateInstanceStorageRequest"},
	      "errors":[
	        {"shape":"ResourceNotFoundException"},
	        {"shape":"InternalServiceException"},
	        {"shape":"InvalidRequestException"},
	  ...
	  "CreateInstance":{
	      ...
	      "documentation":"<p>Creates an Amazon Connect instance.</p>"
	    },
	    "DeleteInstance":{
	        "name":"DeleteInstance",
	        "http":{
  ...
  "shapes":{
    ...
    "IdentityManagementTypes":{
        "type":"list",
        "member":{"shape":"IdentityManagementType"},
        "max":2
    },
    ...
    "CreateInstanceRequest":{
        ...
        "members":{
          ...
          "InstanceAlias":{
            "shape":"InstanceAlias",
            "documentation":"<p>Instance Alias. </p>"
          }
        }
      },
    ...
    "ListContactFlowsRequest":{
      ...
      "members":{
        ...
        "ContactFlowTypes":{
          ...
          "documentation":"<p>The type of contact flow. For descriptions of the available types, see <a href=\"https://docs.aws.amazon.com/connect/latest/adminguide/create-contact-flow.html#contact-flow-types\">Choose a Contact Flow Type</a> in the <i>Amazon Connect Administrator Guide</i>.</p>",
    ...
    "PromptSummary":{
      ...
      "documentation":"<p>Contains summary information about a prompt.</p>"
    },
    "PromptSummaryList":{
      "type":"list",
